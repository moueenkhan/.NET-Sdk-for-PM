...
// </copyright>
namespace PayMarkEFTPOS.Standard.Authentication
{
    using System;
    ...
    public class ClientCredentialsAuthManager : IClientCredentialsAuth, IAuthManager
    {
        ...
        /// <param name="client"> Instance of PayMarkEFTPOSClient.</param>
        public ClientCredentialsAuthManager(
            string oAuthClientId,
            string oAuthClientSecret,
            OAuthToken oAuthToken,
            PayMarkEFTPOSClient client)
        {
        ...
        {
            Models.OAuthToken token = await oAuthApi.CreateRequestTokenAsync(BuildBasicAuthheader(),
